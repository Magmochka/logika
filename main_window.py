...
layout_ans2 = QVBoxLayout()            #вертикальні будуть усередині горизонтальних
...
lb_Result = QLabel("")                   #Напис "привильно/неправильно"
lb_Correct = QLabel("")                  #Текст привильної відповіді
...
AnsGroupBox.hide()                        #Можна приховаати віджет.
